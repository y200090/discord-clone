...
import { NoFriends } from '../../assets';
import { CloseIcon, SearchIcon } from '@chakra-ui/icons';
import { FriendCard } from '../../components';
import { css } from '@emotion/react';

const ShowAll = ({ currentUser }) => {
    ...
    return (
      <>
        <Flex m='auto' direction='column' cursor='default'>
          <Image src={NoFriends} flex='0 1 auto' h='200px' w='415px' mb='40px' />
          <Text m='auto' color='#949ba4' fontSize='16px' lineHeight='20px'>
            友達がいませんが、あなたなら作れるはずです。
          </Text>
        </Flex>
      </>
    )
  ...
  return (
    <>
      ...
      <Box>
        ...
        >
          すべてのフレンド — {currentUser?.friends?.length}
        </Heading>
      </Box>
